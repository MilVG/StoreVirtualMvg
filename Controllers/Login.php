<?php 
	...
	class Login extends Controllers{
		...
		{
			$data['page_id']=1;
			$data['tag_page']="Ingreso Admin-Minimarket";
			$data['page_title']="Ingreso Admin-Minimarket";
			$data['page_name']="login";
			$data['page_function_login']="functionsLogin.js";
			...
			if($_POST){
				if (empty($_POST['txtCorreo']) || empty($_POST['txtpassword'])) {
					...
					if (empty($requestUser)) {
						$arrResponse = array('status' => false,'msg' => 'El usuario o la contraseñ es incorrecto.');
					}else{
						$arrData=$requestUser;
						if ($arrData['status']==1) {
		...
		public function confirmUser(string $params){
			...
			if(empty($params)){
				...
				if(empty($arrResponse)){
					...
					$data['page_functionResetPass'] = "functionResetPass.js";
