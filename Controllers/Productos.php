<?php 
       ...
       class Productos extends Controllers{
		...
		public function Productos($params)
		{
            ...
            $data['page_function_productos']="function_productos.js";
		...
		public function setProductos(){
			...
			if ($_POST) {
				if(empty($_POST['txtNombre']) || empty($_POST['txtCodigo']) || empty($_POST['listCategoria']) || empty($_POST['txtPrecio']) || empty($_POST['listStatus']) )
				{
					...
					$idProducto = intval($_POST['idProductos']);
		...
		public function getProductos()
		{
			if ($_SESSION['permisosMod']['r']){
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($_SESSION['permisosMod']['u']){
						$btnEdit = '<button class="btn btn-primary  btn-sm btnEditProducto" onClick="fntEditProducto('.$arrData[$i]['id_Producto'].')" title="Editar producto"><i class="fas fa-pencil-alt"></i></button>';
					}
					if($_SESSION['permisosMod']['d']){
						$btnDel = '<button class="btn btn-danger btn-sm btnDelProducto" onClick="fntDelProducto('.$arrData[$i]['id_Producto'].')" title="Eliminar producto"><i class="far fa-trash-alt"></i></button>';
					}
