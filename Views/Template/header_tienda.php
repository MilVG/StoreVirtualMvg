<?php
$cantCarrito = 0;
if (isset($_SESSION['arrCarrito']) and count($_SESSION['arrCarrito'])) {
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= media(); ?>css/stylePrin.css">
	<!--===============================================================================================-->
</head>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Bienvenido Usuario: Dsm Sartinis
					</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu" id="list-main">
							<li id="1">
