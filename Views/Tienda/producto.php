...
$rutaCategoria = $arrProducto['categoriaid'].'/'. $arrProducto['rutaCategoria'];
?>
<br><br><br>
<hr>
<!-- breadcrumb -->
                    ...
                    <div class="p-t-33">
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="size-204 flex-w flex-m respon6-next">
                                ...
                                <button id="<?= openssl_encrypt($arrProducto['id_Producto'],METHODENCRIPT,KEY); ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
                                    Agregar al carrito
                                </button>
                            </div>
                        </div>
                ...
                if (!empty($arrProductos)) {
                    for ($p = 0; $p < count($arrProductos); $p++) {
                        ...
                        if (count($arrProductos[$p]['images']) > 0) {
                            ...
                            $portada = media() . 'img/uploads/product.jpg';
                        }
